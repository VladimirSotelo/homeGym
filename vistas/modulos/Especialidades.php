<div class="container-xxl">
    ...
    <div class="py-2 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="d-flex flex-wrap gap-2">
            <a href="nueva_especialidad" class="btn btn-primary"><i class="fas fa-plus"></i> &nbsp; Nueva especialidad</a>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <button href="eliminar_especialidad" class="btn btn-danger btn-sm btnEliminar" id_Especialidad = <?php echo $value["Id_Especialidad"] ?> pag= "especialidades" categoria = "Especialidad" valorElim = "<?php echo $value["especialidad"] ?>"><i class="fas fa-trash"></i></button></td>
                                </tr>
