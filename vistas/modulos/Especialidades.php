                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <button href="eliminar_especialidad" class="btn btn-danger btn-sm btnEliminar" id_eliminar  = <?php echo $value["Id_Especialidad"] ?> pag= "especialidades" categoria = "Especialidad" valorElim = "<?php echo $value["especialidad"] ?>"><i class="fas fa-trash"></i></button></td>
                                </tr>
