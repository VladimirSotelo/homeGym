<div class="container-xxl">
    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-22 fw-bold m-0">Nueva Especialidad</h4>
        </div>
    </div>
    <form method="POST">
        <div class="row"> <!-- Floating Labels -->
            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="especialidad" name="especialidad" placeholder="Especialidad" value="<?= $_POST["especialidad"] ?? '' ?>" required>
                ...
                $guardar->ctrAgregarEspecialidad();
                ?>
                <div class="row">
                    <div class="col-lg-6">
