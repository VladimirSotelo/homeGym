                                    ...
                                    <div class="mb-0 border-0">
                                        <div class="p-0">
                                            <div class="text-center">
                                                <div class="mb-4">
                                                    <a href=" <?php echo $url; ?>login" class="auth-logo">
                                        ...
                                        <div class="pt-0">
                                            <form method="POST" class="my-4">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" type="password" required="" id="contrasena" name="contrasena" placeholder="Ingrese su contraseña">
                                                </div>
