...
$cliente_selec = controladorCliente::crtMostrarCliente($clientes, $valor);
                            ...
                            <div class="col-lg-12">
                                <div class="row g-2">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <input type="text" id="" class="form-control" value="<?php echo $cliente_selec["apellido"] ?>" required>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mb-3">
                                    <label for="example-date" class="form-label">Estado de la misma</label>
                                    <select class="form-select" id="estado">
                                        <option value="<?php echo $cliente_selec["id_EstadoMembresia"] ?>">
                                ...
                                <div class="col-md" -->
                                    ...
                                    <?php
                                    $editer = new controladorCliente();
                                    $editer->ctrEditarCliente();
                                    ?>
                                </div>
                            </div>
                        </div>
