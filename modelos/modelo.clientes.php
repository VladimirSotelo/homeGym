...
class ModeloClientes
{
    ...
    static public function mdlMostrarClientes($clientes, $valor)
    {
        ...
        if ($clientes != null) {
            ...
            try {
                $stmt = Conexion::conectar()->prepare("SELECT * FROM  clientes as c INNER JOIN usuarios as u on u.id_Usuario=c.id_Usuario and $clientes = :$clientes;");
            ...
            try {
                $agentes = Conexion::conectar()->prepare("SELECT * FROM  clientes as c INNER JOIN usuarios as u on u.id_Usuario=c.id_Usuario;");
                $agentes->execute();
