...
class ModeloClientes{
    ...
    static public function mdlAgregarCliente($datos)
    {
        try {
            ...
            $stmt = Conexion::conectar()->prepare("INSERT INTO clientes (nombre, apellio, dni, telefono, direccion, email, usuario, fechaInscripcion, fechaNacimiento) VALUES (:nombre, :apellido, :dni, :telefono, :direccion, :email, :usuario, :fechaInscripcion, :fechaNacimiento)");
